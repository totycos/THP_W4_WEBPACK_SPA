import type { AnySchema, AnySchemaObject, AnyValidateFunction, EvaluatedProperties, EvaluatedItems } from ".pnpm/ajv@8.12.0/node_modules/ajv/dist/types";
import type Ajv from ".pnpm/ajv@8.12.0/node_modules/ajv/dist/core";
import type { InstanceOptions } from ".pnpm/ajv@8.12.0/node_modules/ajv/dist/core";
import { CodeGen, Name, Code, ValueScopeName } from ".pnpm/ajv@8.12.0/node_modules/ajv/dist/compile/codegen";
import { LocalRefs } from ".pnpm/ajv@8.12.0/node_modules/ajv/dist/compile/resolve";
import { JSONType } from ".pnpm/ajv@8.12.0/node_modules/ajv/dist/compile/rules";
